...
def test(test_dataloader, model, device):
    ...
    filename = '0929_argu_results_evaluation.txt'
...
def train(train_dataloader, test_dataloader, args):
    ...
    for epoch in range(0, args.epochs):
        ...
        torch.save(model.state_dict(), f'0929_argu_model_dict/checkpoint_epoch_{epoch+1}.pth')
        print(time.strftime('%Y.%m.%d - %H:%M:%S'))

    # # 모델 저장
    # output_dir = './0928_data1_argu_saved_model'  # 모델을 저장할 경로 지정
...
if __name__ == "__main__":
    ...
    parser.add_argument("-train_data", default="/mnt/d/LLM/file/data1_hatespeech/train_argu.csv")
    parser.add_argument("-val_data", default="/mnt/d/LLM/file/data1_hatespeech/val_okt.csv")
